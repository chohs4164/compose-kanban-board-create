...
import woowacourse.kanban.board.component.newTaskCreate.uiState.rememberCreateTaskFormState
...
fun CreateNewTaskDialog() {
    ...
    Column {
        ...
        Box(modifier = Modifier.padding(vertical = 16.dp)) {
            CreateNewTaskDialogBottom(isCreateEnabled = formState.isCreateEnabled)
        }
    }
}
